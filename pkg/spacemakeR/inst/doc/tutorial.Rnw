...
\SweaveOpts{prefix.string = figs/\Sexpr{.PrefixName}, fig = TRUE, eps = TRUE, width = 6, height = 6}
\begin{quote}
...
@ 
\begin{center}
\includegraphics[width=0.8\textwidth,keepaspectratio]{figs/\Sexpr{.PrefixName}-ni2}
\end{center}
...
\begin{center}
\includegraphics[width=0.4\textwidth,keepaspectratio]{figs/\Sexpr{.PrefixName}-ni3}
\includegraphics[width=0.4\textwidth,keepaspectratio]{figs/\Sexpr{.PrefixName}-ni4}
\end{center}
...
@ 
\begin{center}
\includegraphics[width=0.6\textwidth,keepaspectratio]{figs/\Sexpr{.PrefixName}-ni5}
\end{center}
...
@ 
\begin{center}
\includegraphics[width=0.6\textwidth,keepaspectratio]{figs/\Sexpr{.PrefixName}-ni6}
\end{center}
...
@ 
\begin{center}
\includegraphics[width=0.8\textwidth,keepaspectratio]{figs/\Sexpr{.PrefixName}-ni7}
\end{center}
...
\begin{center}
\includegraphics[width=0.4\textwidth,keepaspectratio]{figs/\Sexpr{.PrefixName}-ni10}
\includegraphics[width=0.4\textwidth,keepaspectratio]{figs/\Sexpr{.PrefixName}-ni11}
\end{center}
...
\begin{center}
\includegraphics[width=0.8\textwidth,keepaspectratio]{figs/\Sexpr{.PrefixName}-ni13}
\end{center}
...
@ 
\begin{center}
\includegraphics[width=0.8\textwidth,keepaspectratio]{figs/\Sexpr{.PrefixName}-ni16}
\end{center}
...
@ 
\begin{center}
\includegraphics[width=0.8\textwidth,keepaspectratio]{figs/\Sexpr{.PrefixName}-ni24}
\end{center}
...
@ 
\begin{center}
\includegraphics[width=0.8\textwidth,keepaspectratio]{figs/\Sexpr{.PrefixName}-ni25}
\end{center}
...
@
\begin{center}
\includegraphics[width=0.8\textwidth,keepaspectratio]{figs/\Sexpr{.PrefixName}-ni25c}
\end{center}
...
@
\begin{center}
\includegraphics[width=0.8\textwidth,keepaspectratio]{figs/\Sexpr{.PrefixName}-ni26}
\end{center}
...
@
\begin{center}
\includegraphics[width=0.8\textwidth,keepaspectratio]{figs/\Sexpr{.PrefixName}-ni34}
\end{center}
...
@
\begin{center}
\includegraphics[width=0.8\textwidth,keepaspectratio]{figs/\Sexpr{.PrefixName}-ni41}
\end{center}
\end{document}
